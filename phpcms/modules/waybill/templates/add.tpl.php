...
<div class="pad-lr-10">
    <div class="main">
        <div class="logInfo">
            <form action="?m=waybill&c=waybill&a=add" method="post">
                ...
                <div class="logInfo_con">
                    ...
                    <div class="logInfo_item">
                        ...
                        <input type="text" name="info[number]">
                    </div>
                    <div class="logInfo_item">
                        <label for="">寄件日期<i>*</i></label>
                        <input type="text" id="checkDate" name="info[sendtime]">
                    </div>
                    <div class="logInfo_item">
                        <label for="">物流方式<i>*</i></label>
                        <div class="raido_box">
                            <input type="radio" class="fb-inlineBlock" name="info[logistics_mode]" value="air_transportation" checked/>
                            <span>空运</span>
                            <input type="radio" class="fb-inlineBlock" name="info[logistics_mode]" value="sea_transportation"/>
                            <span>海运</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="logInfo_con">
                    <div class="logInfo_item">
                        ...
                        <input type="text" name="info[sender]">
                    </div>
                    <div class="logInfo_item"><i>*</i>
                        <label for="">联系号码</label>
                        <input type="text" name="info[sender_mobile]">
                    </div>
                    <div class="logInfo_item">
                        <label for="">寄件地址<i>*</i></label>
                        <textarea name="info[sender_address]" ></textarea>
                    </div>
                    <div class="logInfo_item">
                        <label for="">备注信息</label>
                        <textarea name="info[sender_info]" ></textarea>
                    </div>
                </div>
                <div class="logInfo_title">
                    收件人信息
                ...
                <div class="logInfo_con">
                    <div class="logInfo_item">
                        ...
                        <input type="text" name="info[addressee]">
                    </div>
                    <div class="logInfo_item">
                        <label for="">联系号码<i>*</i></label>
                        <input type="text" name="info[addressee_mobile]">
                    </div>
                    <div class="logInfo_item">
                        <label for="">收件地址<i>*</i></label>
                        <textarea name="info[addressee_address]" ></textarea>
                    </div>
                </div>
                <div class="logInfo_title">
                    物品信息
                ...
                <div class="logInfo_con">
                    <div class="logInfo_item">
                        ...
                        <input type="text" name="info[goods_freight]" >
                    </div>
                    <div class="logInfo_item">
                        <label for="">物品类别<i>*</i></label>
                        <input type="text" name="info[goods_type]" >
                    </div>
                    <div class="logInfo_item">
                        <label for="">物品名称<i>*</i></label>
                        <input type="text" name="info[goods_name]" >
                    </div>
                    <div class="logInfo_item">
                        <label for="">物品件数<i>*</i></label>
                        <input type="text" name="info[goods_number]">
                    </div>
                    <div class="logInfo_item">
                        <label for="">物品价值</label>
                        <input type="text" name="info[goods_price]">
                    </div>
                    <div class="logInfo_item">
                        <label for="">保  价  费</label>
                        <input type="text" name="info[goods_insured]">
                    </div>
                    <div class="logInfo_item">
                        <label for="">物品重量</label>
                        <input type="text" name="info[goods_weight]">
                    </div>
                    <div class="logInfo_item">
                        <label for="">体积重量</label>
                        <input type="text" name="info[goods_volume]">
                    </div>
...
<script>
   ...
   $fb(".logInfo form").formValidator([
            ...
            var url = "?m=waybill&c=waybill&a=add&dosubmit=1"+pc_hash;
