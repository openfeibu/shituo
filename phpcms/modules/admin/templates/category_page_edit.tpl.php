...
<table width="100%" class="table_form ">
	  ...
	  <tr>
		<th>英语名称：</th>
		<td><input type="text" name="info[en_catname]" id="en_catname" class="input-text" value="<?php echo $en_catname;?>"></td>
	  </tr>
	  <tr>
		 <th>阿拉伯名称：</th>
		 <td>
		 <span id="normal_add"><input type="text" name="info[arab_catname]" id="arab_catname" class="input-text" value="<?php echo $arab_catname;?>"></span>
	   </td>
	   </tr>
	<tr>
	...
	<tr>
	  ...
	  <tr>
          <th>英语描述：</th>
          <td>
  		<textarea name="info[en_description]" maxlength="255" style="width:300px;height:60px;"><?php echo $en_description;?></textarea>
  		</td>
        </tr>
	<tr>
        <th>阿拉伯描述：</th>
        <td>
		<textarea name="info[arab_description]" maxlength="255" style="width:300px;height:60px;"><?php echo $arab_description;?></textarea>
		</td>
      </tr>
<tr>
