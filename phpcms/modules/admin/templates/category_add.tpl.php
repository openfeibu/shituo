 ...
 <tr>
     <th><?php echo L('add_category_types');?>：</th>
	  ...
	  <tr>
		<th>英语名称：</th>
		<td>
		<span id="normal_add"><input type="text" name="info[en_catname]" id="en_catname" class="input-text" value=""></span>
	   </td>
	  </tr>
	  <tr>
		 <th>阿拉伯名称：</th>
		 <td>
		 <span id="normal_add"><input type="text" name="info[arab_catname]" id="arab_catname" class="input-text" value=""></span>
	   </td>
	   </tr>
	<tr id="catdir_tr">
