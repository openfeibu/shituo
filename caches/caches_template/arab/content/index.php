...
<div class="main pdt">
    <div class="banner_box fb-position-relative">
        ...
        <div class="w1200 fb-position-absolute cargoTracking_box">
            <div class="cargoTracking">
                ...
                <form action="货物跟踪.html" style="text-align: right">
                    <div class="item">
    ...
    <div class="product_zone w1200">
        <div class="product_ky fb-position-relative fb-transition">
            ...
            <div class="product_ky_text  fb-position-absolute fb-transition">
                ...
                <div class="p_more fb-position-absolute"><a href="<?php echo $CATEGORYS['19']['url'];?>"><?php echo SL('more');?></a></div>
            </div>
        </div>
    ...
    <div class="showDate">
        <div class="w1200">
            <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"get\" data=\"op=get&tag_md5=cd02e5a97fabb74e9a980767c5fc8c81&sql=SELECT+%2A+FROM+shituo_page+where+catid%3D54\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}pc_base::load_sys_class("get_model", "model", 0);$get_db = new get_model();$r = $get_db->sql_query("SELECT * FROM shituo_page where catid=54 LIMIT 20");while(($s = $get_db->fetch_next()) != false) {$a[] = $s;}$data = $a;unset($a);?>
            <?php $n=1; if(is_array($data)) foreach($data AS $key => $val) { ?>
    ...
    <div class="home_ad fb-position-relative">
        <a href="<?php echo $CATEGORYS['6']['url'];?>"><img class="fb-position-absolute" src="<?php echo CSS_PATH;?>shituo/images/home_ad.png" alt=""></a>
    </div>
